...
dp.directive('ngDatepicker', function () {
    return {
        ...
        template: "<div class=\"input-append date\">\n  <input type=\"text\" id=\"datepicker\" ng-model=\"ngModel\" data-date=\"{{ngModel}}\"><span class=\"add-on\"><i class=\"icon-th\"></i></span>\n</div>",
        link: function (scope, element) {

            element.datepicker(scope.ngDateoptions).on('changeDate', function (e) {
                var defaultFormat, defaultLanguage, format, language;
                defaultFormat = $.fn.datepicker.defaults.format;
                format = scope.ngDateoptions.format || defaultFormat;
                defaultLanguage = $.fn.datepicker.defaults.language;
                language = scope.ngDateoptions.language || defaultLanguage;
            ...
            scope.$watch('ngModel', function (newValue) {
                if (!scope.inputHasFocus) {
                    ...
                    for (var i = 0; i < info.length; i++) {
                        ...
                        info[i] = new Date(info[i]);
                        console.log(info[i]);
                        arr.push(info[i]);
                    }
                    console.log(new Date(2018, 2, 7));
                    //return element.datepicker('update', '2018-03-05', '2018-03-07');
